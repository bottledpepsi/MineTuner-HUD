...
public final class TemplateListPanel {
    ...
    /** Truncates a template line preview to fit the panel row, appending an. */
    ...
    public static ClickResult handleClick(int mx, int my, int menuX, int menuY, int screenW, int screenH,
        ...
        if (PanelChrome.isHoveringRow(mx, my, px, backY, PANEL_W, ROW_H)) {
            return ClickResult.CLOSED_RESULT;
        }
    ...
    /** What a click on the line-list panel did. */
    public enum Kind {NONE, CLOSED, EDIT_LINE}

    /** Outcome of a click on the line-list panel. */
