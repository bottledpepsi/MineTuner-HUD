...
public final class CpuStat implements StatDefinition {
    ...
    public String format(int decimals) {
        return MtssDataHolder.getFormattedCpu(decimals);
    }

    @Override
    public String rawValue(int decimals) {
        return MtssDataHolder.getRawCpu(decimals);
    }
    ...
    public float[] history() {
        return MtssDataHolder.getCpuHistory();
    }
    ...
    public int color(MtssConfig.ThresholdSettings custom) {
        return MtssDataHolder.getCpuColor(custom);
    }

    @Override
    public int colorFor(float value, MtssConfig.ThresholdSettings custom) {
        return MtssDataHolder.cpuColorFor(value, custom);
    }
