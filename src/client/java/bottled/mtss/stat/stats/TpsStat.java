...
/** Server ticks per second. Higher is better; color-coded green/yellow/red. */
public final class TpsStat implements StatDefinition {

    @Override public MtssConfig.Stat key() { return MtssConfig.Stat.TPS; }
    @Override public String token() { return "tps"; }
    @Override public String format(int decimals) { return MtssDataHolder.getFormattedTps(decimals); }

    @Override public boolean supportsDecimals() { return true; }
    @Override public boolean supportsGraph() { return true; }
    @Override public float[] history() { return MtssDataHolder.getTpsHistory(); }

    @Override public boolean supportsThreshold() { return true; }
    @Override public boolean higherIsBetter() { return true; }
    @Override public float thresholdStep() { return 0.5f; }
    @Override public float defaultGoodMin() { return 18f; }
    @Override public float defaultWarnMin() { return 14f; }
