...
public final class GpuUsageStat implements StatDefinition {
    ...
    public MtssConfig.Stat key() {
        return MtssConfig.Stat.GPU_USAGE;
    }
    ...
    public String format(int decimals) {
        return MtssDataHolder.getFormattedGpuUsage(decimals);
    }

    @Override
    public String rawValue(int decimals) {
        return MtssDataHolder.getRawGpuUsage(decimals);
    }
    ...
    public float[] history() {
        return MtssDataHolder.getGpuUsageHistory();
    }
