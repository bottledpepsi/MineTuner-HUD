...
public final class ArmorStat implements StatDefinition {
    ...
    public String format(int decimals) {
        return MtssDataHolder.getFormattedArmor();
    }
    ...
    public float[] history() {
        return MtssDataHolder.getArmorHistory();
    }
    ...
    public int color(MtssConfig.ThresholdSettings custom) {
        return MtssDataHolder.getArmorColor(custom);
    }

    @Override
    public int colorFor(float value, MtssConfig.ThresholdSettings custom) {
        return MtssDataHolder.armorColorFor(value, custom);
    }
