...
public final class PingStat implements StatDefinition {
    ...
    public String format(int decimals) {
        return MtssDataHolder.getFormattedPing();
    }

    @Override
    public String rawValue(int decimals) {
        return MtssDataHolder.getRawPing();
    }
    ...
    public float[] history() {
        return MtssDataHolder.getPingHistory();
    }
    ...
    public int color(MtssConfig.ThresholdSettings custom) {
        return MtssDataHolder.getPingColor(custom);
    }

    @Override
    public int colorFor(float value, MtssConfig.ThresholdSettings custom) {
        return MtssDataHolder.pingColorFor(value, custom);
    }
}
