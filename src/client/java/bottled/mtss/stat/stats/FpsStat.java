...
public final class FpsStat implements StatDefinition {
    ...
    public String format(int decimals) {
        return MtssDataHolder.getFormattedFps();
    }
    ...
    public float[] history() {
        return MtssDataHolder.getFpsHistory();
    }
    ...
    public int color(MtssConfig.ThresholdSettings custom) {
        return MtssDataHolder.getFpsColor(custom);
    }

    @Override
    public int colorFor(float value, MtssConfig.ThresholdSettings custom) {
        return MtssDataHolder.fpsColorFor(value, custom);
    }
}
