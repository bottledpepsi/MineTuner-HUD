...
public final class HungerStat implements StatDefinition {
    ...
    public String format(int decimals) {
        return MtssDataHolder.getFormattedHunger();
    }
    ...
    public float[] history() {
        return MtssDataHolder.getHungerHistory();
    }
    ...
    public int color(MtssConfig.ThresholdSettings custom) {
        return MtssDataHolder.getHungerColor(custom);
    }

    @Override
    public int colorFor(float value, MtssConfig.ThresholdSettings custom) {
        return MtssDataHolder.hungerColorFor(value, custom);
    }
