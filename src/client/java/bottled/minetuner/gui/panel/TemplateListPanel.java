...
public final class TemplateListPanel {
    ...
    public static int rowCount(MineTunerConfig.StatListConfig lc) {
        return 1 + lc.templateLines.size() + 2; // header + lines + add + back.
    }

    public static int panelHeight(MineTunerConfig.StatListConfig lc) {
    ...
    public static void render(GuiGraphicsExtractor g, net.minecraft.client.gui.Font font,
        ...
        g.text(font, "§e" + I18n.get("gui.minetuner.template.title"),
    ...
    private static void renderLineRow(GuiGraphicsExtractor g, net.minecraft.client.gui.Font font,
                                      int mx, int my, int px, int ry, MineTunerConfig.StatListConfig lc,
        ...
        String preview = raw.isEmpty() ? "§7" + I18n.get("gui.minetuner.template.empty_line")
                : "§f" + truncateForRow(font, raw, PANEL_W - PANEL_PAD - 24);
        g.text(font, I18n.get("gui.minetuner.template.line_number", index + 1) + " " + preview,
    ...
    public static void renderEditBox(GuiGraphicsExtractor g, net.minecraft.client.gui.Font font,
        ...
        String prompt = "§e" + I18n.get("gui.minetuner.template.edit_prompt", templateEditIndex + 1);
