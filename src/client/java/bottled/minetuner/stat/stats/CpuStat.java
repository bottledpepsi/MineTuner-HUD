...
public final class CpuStat implements StatDefinition {
    ...
    public String format(int decimals) {
        return MineTunerDataHolder.getFormattedCpu(decimals);
    }

    @Override
    public String rawValue(int decimals) {
        return MineTunerDataHolder.getRawCpu(decimals);
    }
    ...
    public float[] history() {
        return MineTunerDataHolder.getCpuHistory();
    }
    ...
    public int color(MineTunerConfig.ThresholdSettings custom) {
        return MineTunerDataHolder.getCpuColor(custom);
    }

    @Override
    public int colorFor(float value, MineTunerConfig.ThresholdSettings custom) {
        return MineTunerDataHolder.cpuColorFor(value, custom);
    }
