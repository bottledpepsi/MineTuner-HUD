...
import bottled.minetuner.stat.stats.*;

import java.util.LinkedHashMap;
import java.util.List;
import java.util.Map;

/** Central lookup from {@link MineTunerConfig.Stat} to its {@link StatDefinition}. */
public final class StatRegistry {

    private static final Map<MineTunerConfig.Stat, StatDefinition> BY_KEY = new LinkedHashMap<>();
    ...
    static {
        ...
        // MineTunerConfig.hardwareSensorsEnabled is true and LHM is reachable — see
    ...
    public static StatDefinition get(MineTunerConfig.Stat stat) {
     ...
     *  the caller — see {@link bottled.minetuner.hud.TemplateEngine#tryParseTokenBody}). */
     ...
     *  MineTunerConfig.Stat} enum's grouping by category but isn't guaranteed identical to
