...
final class LineBuilder {
    ...
    public static void buildLines(MineTunerConfig.StatListConfig cfg,
    ...
    /** Template mode. */
    private static void buildTemplateLines(MineTunerConfig.StatListConfig cfg,
                                           List<String> lines, List<Integer> colors, List<List<TemplateEngine.ColoredRun>> runs,
                                           List<GraphEntry> graphEntries, List<RowKind> rowKinds) {
    ...
    /** Classic mode. */
    private static void buildClassicLines(MineTunerConfig.StatListConfig cfg,
                                          List<String> lines, List<Integer> colors, List<List<TemplateEngine.ColoredRun>> runs,
                                          List<GraphEntry> graphEntries, List<RowKind> rowKinds) {
        for (MineTunerConfig.Stat stat : cfg.getVisibleStats()) {
    ...
    private static GraphEntry buildGraphEntry(MineTunerConfig.StatListConfig cfg, MineTunerConfig.Stat stat) {
        StatDefinition def = StatRegistry.get(stat);

        MineTunerConfig.StatSettings statSettings = cfg.getStatSettings(stat);
        int decimals = statSettings.decimals;
        MineTunerConfig.GraphStyle style = statSettings.graphStyle;
        ...
        MineTunerConfig.ThresholdSettings entryThreshold = def.supportsThreshold()
