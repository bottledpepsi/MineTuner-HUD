...
public final class MineTunerDataHolder {
    ...
    // Fed directly by LevelRenderEvents.START_MAIN (see MineTunerClient), NOT by SamplingDriver
    ...
    // HardwareSensorPoller's dedicated background thread (bottled.minetuner.sample),
     ...
     *  (see MineTunerDataHolder.updateFastMetrics's memHistory.push call) rather than
    ...
    public static String getFormattedTps(int decimals) {
        return t("minetuner.stat.tps", fmt(getTps(), decimals));
    }
    ...
    public static String getFormattedMspt(int decimals) {
        return mspt >= 0f ? t("minetuner.stat.mspt", fmt(mspt, decimals)) : "";
    }

    public static String getFormattedFps() {
        return t("minetuner.stat.fps", fps);
    }
    ...
    public static String getFormattedFrametime(int decimals) {
        return t("minetuner.stat.frametime", fmt(frametimeMs, decimals));
    }
    ...
    public static String getFormattedPing() {
        return ping >= 0 ? t("minetuner.stat.ping", ping) : t("minetuner.stat.ping.na");
    }
    ...
    public static String getFormattedMem() {
        return t("minetuner.stat.memory", memUsedMb, memMaxMb);
    }
    ...
    public static String getFormattedCpu(int decimals) {
        return cpuPercent >= 0 ? t("minetuner.stat.cpu", fmt(cpuPercent, decimals)) : t("minetuner.stat.cpu.na");
    }
    ...
    public static String getFormattedEntities() {
        return t("minetuner.stat.entities", entityCount);
    }

    public static String getFormattedChunks() {
        return t("minetuner.stat.chunks", loadedChunks);
    }

    public static String getFormattedRendered() {
        return t("minetuner.stat.rendered", renderedSections);
    }

    public static String getFormattedCoords() {
        return t("minetuner.stat.coords", (int) Math.floor(playerX), (int) Math.floor(playerY), (int) Math.floor(playerZ));
    }

    public static String getFormattedX() {
        return t("minetuner.stat.x", (int) Math.floor(playerX));
    }

    public static String getFormattedY() {
        return t("minetuner.stat.y", (int) Math.floor(playerY));
    }

    public static String getFormattedZ() {
        return t("minetuner.stat.z", (int) Math.floor(playerZ));
    }
    ...
    public static String getFormattedFacing() {
        return t("minetuner.stat.facing", facingName);
    }
    ...
    public static String getFormattedYaw(int decimals) {
        return t("minetuner.stat.yaw", fmt(playerYaw, decimals));
    }
    ...
    public static String getFormattedPitch(int decimals) {
        return t("minetuner.stat.pitch", fmt(playerPitch, decimals));
    }
    ...
    public static String getFormattedSpeed(int decimals) {
        return t("minetuner.stat.speed", fmt(speedBps, decimals));
    }
    ...
    public static String getFormattedGcTime() {
        return t("minetuner.stat.gc", gcTimeMs);
    }
    ...
    public static String getFormattedBiome() {
        return t("minetuner.stat.biome", biomeName.isEmpty() ? "?" : biomeName);
    }

    public static String getFormattedLight() {
        return t("minetuner.stat.light", lightLevel);
    }

    public static String getFormattedDimension() {
        return t("minetuner.stat.dimension", dimensionName.isEmpty() ? "?" : dimensionName);
    }

    public static String getFormattedHealth() {
        return t("minetuner.stat.health", fmt(health, 0), fmt(maxHealth, 0));
    }
    ...
    public static String getFormattedHunger() {
        return t("minetuner.stat.hunger", hunger);
    }
    ...
    public static String getFormattedSaturation(int decimals) {
        return t("minetuner.stat.saturation", fmt(saturation, decimals));
    }
    ...
    public static String getFormattedXpLevel() {
        return t("minetuner.stat.xp_level", xpLevel);
    }
    ...
    public static String getFormattedXpProgress(int decimals) {
        return t("minetuner.stat.xp_progress", fmt(xpProgress * 100.0, decimals));
    }
    ...
    public static String getFormattedGameMode() {
        ...
        return t("minetuner.stat.game_mode", display);
    }

    public static String getFormattedSelectedSlot() {
        return t("minetuner.stat.selected_slot", selectedSlot + 1);
    }

    public static String getFormattedHeldItem() {
        return t("minetuner.stat.held_item", heldItemName.isEmpty() ? "-" : heldItemName);
    }
    ...
    public static String getFormattedVerticalSpeed(int decimals) {
        return t("minetuner.stat.vertical_speed", fmt(verticalSpeedBps, decimals));
    }
    ...
    public static String getFormattedWeather() {
        String state = isThundering ? t("minetuner.stat.weather.thunder")
                : isRaining ? t("minetuner.stat.weather.rain")
                : t("minetuner.stat.weather.clear");
        return t("minetuner.stat.weather", state);
    }

    public static String getFormattedDifficulty() {
        String raw = difficultyName;
        String display = raw.isEmpty() ? "?" : Character.toUpperCase(raw.charAt(0)) + raw.substring(1);
        return t("minetuner.stat.difficulty", display);
    }

    public static String getFormattedSkyLight() {
        return t("minetuner.stat.sky_light", skyLight);
    }

    public static String getFormattedBlockLight() {
        return t("minetuner.stat.block_light", blockLight);
    }

    public static String getFormattedCanSeeSky() {
        return t("minetuner.stat.can_see_sky", canSeeSky ? t("gui.minetuner.menu.on") : t("gui.minetuner.menu.off"));
    }

    public static String getFormattedPlayersOnline() {
        return t("minetuner.stat.players_online", playersOnline);
    }

    public static String getFormattedChunkPos() {
        return t("minetuner.stat.chunk_pos", chunkX, chunkZ);
    }
    ...
    public static String getFormattedDistanceFromSpawn(int decimals) {
        return t("minetuner.stat.distance_from_spawn", fmt(distanceFromSpawn, decimals));
    }
    ...
    public static String getFormattedLookingAt() {
        return lookingAtName.isEmpty() ? "" : t("minetuner.stat.looking_at", lookingAtName);
    }

    /** Bare targeted-thing name, or a translated placeholder for Template Mode. */
    public static String getRawLookingAt() {
        return lookingAtName.isEmpty() ? t("minetuner.stat.looking_at.none") : lookingAtName;
    }

    public static String getFormattedMoving() {
        return t("minetuner.stat.moving", isMoving ? t("gui.minetuner.menu.on") : t("gui.minetuner.menu.off"));
    }
    ...
    public static String getFormattedGpuTemp(int decimals) {
        return gpuTempC >= 0 ? t("minetuner.stat.gpu_temp", fmt(gpuTempC, decimals)) : "";
    }
    ...
    public static String getFormattedGpuClock(int decimals) {
        return gpuClockMhz >= 0 ? t("minetuner.stat.gpu_clock", fmt(gpuClockMhz, decimals)) : "";
    }
    ...
    public static String getFormattedGpuUsage(int decimals) {
        return gpuUsagePercent >= 0 ? t("minetuner.stat.gpu_usage", fmt(gpuUsagePercent, decimals)) : "";
    }
    ...
    public static String getFormattedVramUsed() {
        ...
        return (vramUsedMb >= 0 && vramMaxMb > 0)
                ? t("minetuner.stat.vram_used", Math.round(vramUsedMb), Math.round(vramMaxMb))
                : "";
    }
